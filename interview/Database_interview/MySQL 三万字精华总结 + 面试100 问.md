...
![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff308f75df1~tplv-t2oaga2asx-watermark.image)
...
![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff308eb9e2d~tplv-t2oaga2asx-watermark.image)
...
![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff309fc730f~tplv-t2oaga2asx-watermark.image)
...
![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff30a28cf0d~tplv-t2oaga2asx-watermark.image)

![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff309f9eea0~tplv-t2oaga2asx-watermark.image)

![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff30a5e00fe~tplv-t2oaga2asx-watermark.image)
...
- 可以简单的理解为“排好序的快速查找数据结构”，数据本身之外，**数据库还维护者一个满足特定查找算法的数据结构**，这些数据结构以某种方式引用（指向）数据，这样就可以在这些数据结构上实现高级查找算法。这种数据结构，就是索引。下图是一种可能的索引方式示例。
    ...
    ![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff356f9f2f0~tplv-t2oaga2asx-watermark.image)
...
![索引](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff356b40f0d~tplv-t2oaga2asx-watermark.image)
...
将上一节中的B-Tree优化，由于B+Tree的非叶子节点只存储键值信息，假设每个磁盘块能存储4个键值及指针信息，则变成B+Tree后其结构如下图所示： ![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff3498c6715~tplv-t2oaga2asx-watermark.image)
...
![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff35bbbf112~tplv-t2oaga2asx-watermark.image)
...
![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff337681c17~tplv-t2oaga2asx-watermark.image)
...
![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff365f39d10~tplv-t2oaga2asx-watermark.image)
...
- 总结
    ...
    ![sql-parse](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff368752ece~tplv-t2oaga2asx-watermark.image)
...
![sql-joins](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff37ac0e7f6~tplv-t2oaga2asx-watermark.image)
...
![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff377ece423~tplv-t2oaga2asx-watermark.image)
...
![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff37e532a33~tplv-t2oaga2asx-watermark.image)
...
![expalin](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff38d5d8333~tplv-t2oaga2asx-watermark.image)
...
![explain-key](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff38f6a6955~tplv-t2oaga2asx-watermark.image)
...
![explain-demo](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff39882383d~tplv-t2oaga2asx-watermark.image)
...
![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff39ffffdd1~tplv-t2oaga2asx-watermark.image)
...
- 三个步骤
    ...
    ![img](https://cdn.jsdelivr.net/gh/Mark-Jackson-Github/images@master/uPic/1734bff3c7c7b231~tplv-t2oaga2asx-watermark.image)
